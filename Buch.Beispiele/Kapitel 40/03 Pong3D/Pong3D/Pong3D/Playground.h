...
private:
	...
	std::unique_ptr<AlphaTestEffect> alphaEffect;
	Microsoft::WRL::ComPtr<ID3D11InputLayout> alphaInputLayout;
	...
	Microsoft::WRL::ComPtr<ID3D11Buffer> ballVertexBuffer;
	XMMATRIX view;
...
public:
	...
	void Render3D(SpriteBatch* batch);
